...
describe('[get_var]', () => {
  test('should decode string', () => {
    // given
    const buffer = new Buffer('0100000004000000040000007465737404000000020000004f4b0300', 'hex');
  ...
  test('should decode int', () => {
    // given
    const buffer = new Buffer('0100000004000000040000007465737402000100d204000000000000', 'hex');
  ...
  test('should decode variant', () => {
    ...
    const buffer = new Buffer(
      '0200000004000000040000007465737402000100d20400000000000004000000040000006d6f7265' +
