...
describe('misc types', () => {
  beforeAll(() => {
    jest.mock('../encode/color', () => jest.fn(() => 'color'));
    jest.mock('../encode/node_path', () => jest.fn(() => 'node_path'));
    jest.mock('../encode/array', () => jest.fn(() => 'array'));
  });

  test('should resolve encoder as misc type Color', () => {
    // eslint-disable-next-line global-require
    const Variant = require('../misc/color');
    ...
    // then
    expect(encoder).toBe('color');
  });

  test('should resolve encoder as misc type NodePath', () => {
    // eslint-disable-next-line global-require
    const Variant = require('../misc/node_path');
    ...
    // then
    expect(encoder).toBe('node_path');
  });

  test('should resolve encoder as misc type Array', () => {
    // given
    const variant = [];
